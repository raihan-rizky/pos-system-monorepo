    ...
    groups: [
      {
        ...
        targets: [
          ...
          { key: "suppliers-goods-purchase-tab", label: "Tab Pembelian Barang" },
        ],
      },
      {
        ...
        targets: [
          ...
          { key: "suppliers-request-quantity", label: "Kebutuhan & Estimasi" },
          { key: "suppliers-approve", label: "Setujui Permohonan" },
          { key: "suppliers-goods-purchase-create", label: "Buat Pembelian Barang" },
          { key: "suppliers-goods-purchase-form", label: "Form Produk & Harga" },
          { key: "suppliers-goods-purchase-approve", label: "Review per Produk" },
        ],
      },
    ],
  },
