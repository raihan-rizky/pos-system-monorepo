...
describe("visual help guides", () => {
  ...
  it("selects the real tab, subtab, and overlay state for representative workflow targets", () => {
    const cases = [
      ...
      ["suppliers", "suppliers-goods-purchase-create", "suppliers-goods-purchase-create-open", "Buat Pembelian Barang"],
      ["suppliers", "suppliers-goods-purchase-approve", "suppliers-goods-purchase-approve-open", "Belum Ada Aksi"],
