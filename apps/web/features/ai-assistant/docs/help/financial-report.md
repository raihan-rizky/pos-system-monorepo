...
Ekspor dari chat tidak mengunduh file otomatis. Pak Teladan menampilkan kartu file dengan tombol **Download PDF/Excel**, dan kartu langsung menyertakan saran berbasis laporan yang sama tanpa perlu mengunduh. Setelah unduhan pertama berhasil, tombol berubah menjadi **Download ulang**. Role OWNER juga memiliki quick prompt **Rekap finansial bulanan**.
