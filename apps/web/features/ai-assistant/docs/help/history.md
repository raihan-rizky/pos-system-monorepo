...
- **Cetak & Marking Surat Jalan:** Surat jalan pengiriman barang fisik dapat dibuat dari menu aksi transaksi berstatus Lunas/DP. Untuk keperluan inventaris/gudang, Surat Jalan wajib ditandai status penanganannya (**Marking**):
  ...
  - Langkah detail pembuatan Surat Jalan dibahas di [FAQ](file:///d:/main_project/pos-system-monorepo/apps/web/features/ai-assistant/docs/help/faq.md#q8-bagaimana-cara-membuat-surat-jalan-pengiriman-delivery-order-barang-ke-pelanggan). Langkah marking dibahas di [FAQ](file:///d:/main_project/pos-system-monorepo/apps/web/features/ai-assistant/docs/help/faq.md#q28-bagaimana-cara-melakukan-marking-pada-surat-jalan-delivery-order).
