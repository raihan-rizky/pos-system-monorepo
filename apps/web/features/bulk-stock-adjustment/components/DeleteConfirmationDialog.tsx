    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      ...
      >
        ...
        <p className="mb-6 text-center text-sm text-slate-600">
          This action cannot be undone. The selected product{selectedCount !== 1 ? "s" : ""} will be permanently deleted from your inventory.
        </p>

        {/* Warning */}
        <div className="mb-6 rounded-lg bg-red-50 p-3 text-sm text-red-700">
          <p className="font-medium">?? Warning</p>
          <p className="mt-1">All associated data including stock history will be deleted.</p>
        </div>
