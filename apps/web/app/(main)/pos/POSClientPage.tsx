  ...
  return (
    <>
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Products Area */}
        {/* Layout fix: remove fixed width, hide overflow, and keep min-w-0 */}
            ...
            >
              ...
              >
                {hideOutOfStock ? (
                  ...
                  <CircleMinus className="h-3.5 w-3.5" strokeWidth={2.5} aria-hidden="true" />
                )}
              ...
              {categories.map((cat) => (
                ...
                `}
                >
                  <CategoryIcon value={cat.icon} className="h-3.5 w-3.5" />
                  <span>{cat.name}</span>
