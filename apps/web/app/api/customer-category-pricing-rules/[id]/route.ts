...
const patchRuleSchema = z
  .object({
    ...
    customerType: z.string().refine(isCustomerType, "Tipe pelanggan tidak valid").optional(),
...
export async function PATCH(
  ...
  try {
    ...
    const nextCustomerType = data.customerType ?? (existing.customerType as CustomerType);
