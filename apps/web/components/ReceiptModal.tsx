          ...
          >
            ...
            <div className={`flex flex-col b ${compact ? "mb-1" : "mb-2"}`}>
              <div className="flex items-baseline">
                ...
                >
                  <span className={compact ? "text-[26px]" : "text-[36px]"}>
                    T
                  </span>
                  OKO{" "}
                  <span
                    className={`${compact ? "text-[26px]" : "text-[36px]"} ml-1`}
                  >
                    T
                  </span>
                  ELADAN
              ...
              >
                Jl. Temu Putih No.30 Cilegon | Telp: 0254 393022 |
                tokoteladancv@gmail.com
              </p>
            </div>
            ...
            >
              ...
              <div className="flex flex-col items-end">
                <div className={`flex ${compact ? "w-[300px]" : "w-[350px]"}`}>
                  ...
                  <div
                    className={`border border-black bg-[#e5e7eb] ${compact ? "py-0.5 px-3" : "py-2 px-4"} font-bold text-center ${compact ? "w-[150px]" : "w-[180px]"}`}
                  >
